...
public class JdbcTimeEntryRepositoryTest {
    ...
    public void createInsertsATimeEntryRecord() {
        ...
        Map<String, Object> foundEntry =
                jdbcTemplate.queryForMap("Select * from time_entries where id = ?", entry.getId());
    ...
    public void updateUpdatesTheRecord() {
        ...
        Map<String, Object> foundEntry =
                jdbcTemplate.queryForMap("Select * from time_entries where id = ?", timeEntry.getId());
    ...
    public void deleteRemovesTheRecord() {
        ...
        Map<String, Object> notFoundEntry =
                jdbcTemplate.queryForMap("Select count(*) count from time_entries where id = ?", 999);
        assertThat(notFoundEntry.get("count")).isEqualTo(0L);
        Map<String, Object> foundEntry =
                jdbcTemplate.queryForMap("Select count(*) count from time_entries where id = ?", 888);
